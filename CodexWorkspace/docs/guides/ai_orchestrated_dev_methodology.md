...
## Core Artifacts
- development.md (repo root): canonical architecture, milestones, and constraints.
- Code-Tasks: implementation tasks for gpt-5.2-codex.
- Ask-Tasks: review/analysis tasks for gpt-5.2.
- CodexWorkspace/docs/backlog.md: non-urgent work captured for later.

## Quick Start
1. Fill out `CodexWorkspace/docs/plans/plan_template.md` in plain language.
2. Run the Planning prompt with gpt-5.2 to create `development.md`.
...
7. Capture non-urgent tasks using the Backlog prompt.
8. Run the Next Feature prompt when the current feature is complete.

## Phase Map
| Phase | Trigger | Model | Prompt File | Expected Output |
| --- | --- | --- | --- | --- |
| Planning | New repo or new feature | gpt-5.2 | `CodexWorkspace/prompts/planning_phase_prompt.txt` | `development.md` |
...
| Backlog | Non-urgent tasks found | gpt-5.2 | `CodexWorkspace/prompts/backlog_code_task_prompt.txt` | CodexWorkspace/docs/backlog.md updated |
...
- Validate completeness against `development.md`.
