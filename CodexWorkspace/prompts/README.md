...
- `planning_phase_prompt.txt` - create development.md with architecture and milestones (gpt-5.2).
...
- `backlog_code_task_prompt.txt` - document non-urgent tasks in CodexWorkspace/docs/backlog.md (gpt-5.2).
